-- Fix execute_trade to properly handle leverage: deduct margin (notional/leverage)
-- instead of full notional value. Merges risk management checks (HALTED, CLOSE_ONLY,
-- exposure) with leverage/margin/netting logic and virtual/real balance support.
...
BEGIN
    ...
    -- Lock profile and get correct balance

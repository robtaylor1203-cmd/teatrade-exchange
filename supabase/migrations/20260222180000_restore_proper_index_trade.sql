-- Restore the proper execute_index_trade function with full leverage, margin
-- tracking, netting (long/short), and virtual/real balance support.
-- Migration 20260222150000 accidentally overwrote this with a simplified version
-- that broke leveraged closes and shorts.

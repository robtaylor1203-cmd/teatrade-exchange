-- FCA Consumer Protection: closing trades must NEVER be blocked
-- Risk checks (HALTED, CLOSE_ONLY, exposure limits) only apply to
-- trades that OPEN or INCREASE exposure, not to trades closing positions.

-- Switch stop-out from margin-ratio based to equity-floor based.
-- Liquidation fires when total equity (balance + unrealized P/L) drops to
-- 5% of the default starting balance ($500 for $10,000 accounts).
-- Warning at 15% ($1,500).

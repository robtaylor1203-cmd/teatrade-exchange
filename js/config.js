...
const defaultDbIndexes = [
    ...
    { symbol: 'JAKARTA', name: 'Jakarta Auction (Indonesia)', teas: ['IDN-BOP', 'IDN-PF', 'IDN-DUST', 'IDN-BT'], color: 'var(--accent-teal)', currency: 'Rp', multiplier: 15700, forexKey: 'usd_idr', is_market_card: true },

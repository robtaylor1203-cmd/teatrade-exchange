...
const state = {
    ...
    teaHistoricalData: {},
    indexHistoricalData: {},
    mainChartData: { name: 'Kenyan Tea Price Index', symbol: 'KENYA', basePrice: 3.42, change: 2.4, currency: '$', volume: '8.2M' },
    chartMetrics: {},
    ...
    // Previous macro values for calculating change direction
    previousMacro: {},
...
const defaultDbIndexes = [
    { symbol: 'KENYA', name: 'Kenya Tea Index', teas: ['KEN-BP1', 'KEN-PF1', 'KEN-DUST'], color: 'var(--accent-green)', currency: '$', multiplier: 1, is_market_card: false },
    ...
    { symbol: 'AFRICA', name: 'African Tea Index', teas: ['KEN-BP1', 'KEN-PF1', 'MLW-BP1', 'RWA-OP'], color: 'var(--accent-green)', currency: '$', multiplier: 1, is_market_card: false },
    ...
    { symbol: 'MOMBASA', name: 'Mombasa Auction Index', teas: ['KEN-BP1', 'KEN-PF1', 'KEN-DUST'], color: 'var(--accent-green)', currency: '$', multiplier: 1, is_market_card: true },
...
const teaDisplayData = {
    ...
    'KEN-DUST': { grade: 'DUST', estate: 'Kenya Dust', origin: 'Kenya', lot: 24605, qty: 5400, buyer: '\u2014', status: 'BIDDING' },

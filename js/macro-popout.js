...
const MACRO_DEFS = {
    ...
    usdcny: {
        ...
        corrNote:    'China is both major producer and consumer',
        insight:     'A stronger CNY increases Chinese purchasing power for imported specialty teas. China is both the world\'s largest producer and consumer of tea. CNY moves also affect Yunnan Gold and other Chinese-origin prices on this platform.',
        impactLabel: 'Yunnan Origin',
        impactIcon:  '🍵',
